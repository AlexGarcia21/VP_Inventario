<div class="min-h-screen bg-vp-beige p-8 font-sans text-vp-oscuro">
    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div class="md:col-span-8">
            ...
            <!-- Catálogo de Insumos (Estilo Figma) -->
            <div class="bg-white p-6 rounded-xl shadow-sm mb-6 border-t-4 border-vp-lavanda">
                 ...
                 <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                     ...
                     <div class="bg-vp-beige p-4 rounded-xl border border-gray-100 flex flex-col items-center hover:shadow-md transition-shadow">
                         ...
                         <span class="font-bold text-vp-oscuro text-sm mb-1">Papel Higiénico</span>
                         <span class="text-xs text-vp-gris mb-4">Stock: 240</span>
                         
                         <button class="bg-vp-morado hover:bg-vp-oscuro text-white text-xs font-bold py-2 px-4 rounded-lg w-full transition-colors">
                             Agregar
                         </button>
                     </div>
                     
                     <!-- Tarjeta de Insumo de Ejemplo 2 -->
                     <div class="bg-vp-beige p-4 rounded-xl border border-gray-100 flex flex-col items-center hover:shadow-md transition-shadow">
                         <span class="text-3xl mb-3">🧴</span>
                         <span class="font-bold text-vp-oscuro text-sm mb-1">Jabón Líquido</span>
                         <span class="text-xs text-vp-gris mb-4">Stock: 45</span>
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm border-t-4 border-vp-lavanda">
                ...
                <button class="w-full bg-vp-oscuro hover:bg-black text-white font-bold py-3 rounded-lg transition-colors shadow-md">
